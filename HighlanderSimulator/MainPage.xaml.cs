...
namespace HighlanderSimulator
{
    public sealed partial class MainPage : Page
    {
        ...
        public MainPage()
        {
            ...
            this.gameResultRepository = new GameResultRepository("Server=(local);Database=Group Project;User=GroupProject;Password=groupproject");
        }
        ...
        private async Task DisplayOption1Outcome(Highlander[,] grid, Highlander winner, Highlander victim, int iterations)
        {
            ...
            using (var gameResultRepository = new GameResultRepository("Server=(local);Database=Group Project;User=GroupProject;Password=groupproject"))
            {
